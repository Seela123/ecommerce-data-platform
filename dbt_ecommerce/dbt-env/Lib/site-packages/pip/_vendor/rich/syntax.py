...
class Syntax(JupyterMixin):
    ...
    def _process_code(self, code: str) -> Tuple[bool, str]:
        """
        Applies various processing to a staging code string
        (normalises it so it always ends with a line return, dedents it if necessary, etc.)

        Args:
            code (str): The staging code string to process

        Returns:
            Tuple[bool, str]: the boolean indicates whether the staging code ends with a line return,
